...
type NewUser struct {
	...
	Nickname string `protobuf:"bytes,1,opt,name=nickname,proto3" json:"nickname,omitempty"` // 사용자 이름
	Email    string `protobuf:"bytes,2,opt,name=email,proto3" json:"email,omitempty"`       // 이메일 주소
	Pwhash   string `protobuf:"bytes,3,opt,name=pwhash,proto3" json:"pwhash,omitempty"`     // 비밀번호 해시
}
...
func (x *NewUser) GetPwhash() string {
	if x != nil {
		return x.Pwhash
	}
	return ""
...
type User struct {
	...
	UserId    int32                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`         // 사용자 ID
	Nickname  string                 `protobuf:"bytes,2,opt,name=nickname,proto3" json:"nickname,omitempty"`                    // 사용자 이름
	Email     string                 `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`                          // 이메일 주소
	Pwhash    string                 `protobuf:"bytes,4,opt,name=pwhash,proto3" json:"pwhash,omitempty"`                        // 비밀번호 해시
	CreatedAt *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"` // 생성 일자
}
...
var file_usermgmt_usermgmt_proto_rawDesc = []byte{
	...
	0x67, 0x6d, 0x74, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x53, 0x0a, 0x07, 0x4e, 0x65, 0x77, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x6c, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x77, 0x68, 0x61, 0x73, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x70, 0x77, 0x68, 0x61, 0x73, 0x68, 0x22, 0xa4, 0x01, 0x0a, 0x04, 0x55, 0x73,
	...
	0x06, 0x70, 0x77, 0x68, 0x61, 0x73, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70,
	0x77, 0x68, 0x61, 0x73, 0x68, 0x12, 0x39, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64,
	...
	0x75, 0x73, 0x65, 0x72, 0x73, 0x32, 0x83, 0x01, 0x0a, 0x0e, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x61,
	...
	0x73, 0x65, 0x72, 0x6d, 0x67, 0x6d, 0x74, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x22, 0x00, 0x12, 0x3b,
	...
	0x55, 0x73, 0x65, 0x72, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x42, 0x27, 0x5a, 0x25, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x69, 0x74, 0x68, 0x74, 0x68,
	0x65, 0x6d, 0x6f, 0x6f, 0x6e, 0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x2f, 0x6c, 0x61, 0x67, 0x6f,
	0x73, 0x65, 0x72, 0x76, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_usermgmt_usermgmt_proto_depIdxs = []int32{
	4, // 0: usermgmt.User.created_at:type_name -> google.protobuf.Timestamp
	1, // 1: usermgmt.UsersList.users:type_name -> usermgmt.User
	0, // 2: usermgmt.UserManagement.CreateNewUser:input_type -> usermgmt.NewUser
	...
	3, // 5: usermgmt.UserManagement.GetUsers:output_type -> usermgmt.UsersList
